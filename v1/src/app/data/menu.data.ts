...
import { GoodsManagerPageComponent } from '../pages/goods-manager/goods-manager-page.component';
        ...
        children: [
          {
            ...
            description: 'Structural goods manager shell using fixtures and SDK layout conventions.',
          },
        ],
      },
      {
