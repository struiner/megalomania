...
- **Remain at Structural fidelity (pending clarification/data)**
  ...
  - **Auxiliary settings/help actions**: Destinations and CTA routing require product/UX confirmation.
...
- **HUD auxiliary destination clarification** — finalize routing/CTA ownership for non-overlay actions (settings/help) and codify fallback behavior.
